  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 md:bottom-4 md:right-4 z-50 w-14 h-14 md:w-12 md:h-12 rounded-full bg-blue-600 text-white flex items-center justify-center shadow-lg hover:shadow-xl transition animate-pulse"
      ...
      <AnimatePresence>
        {isPopupOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-5 z-[100000] w-80 bg-white rounded-xl shadow-xl border"
          >
            {/* Header */}
            ...
            {/* Content */}
            <div className="p-4">
              <p className="text-gray-700 mb-4">Xin chào! Rất vui khi được hỗ trợ bạn</p>
      ...
      <AnimatePresence>
        {isChatbotOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="fixed bottom-20 right-5 z-[100000] w-80 h-96 bg-white rounded-xl shadow-xl border"
          >
            <div className="bg-blue-500 text-white p-4 rounded-t-xl flex items-center justify-between">
